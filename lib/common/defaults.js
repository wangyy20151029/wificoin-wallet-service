...
Defaults.NOTIFICATIONS_TIMESPAN = 60 * 1024;
...
Defaults.RateLimit = {
  createWallet: {
    ...
    max: 150, // start blocking after 20 request
  ...
  estimateFee: {
   windowMs: 60 * 10 *1000, // 10 min window
    ...
    max: 1024, // start blocking after 200 request
    message: 'Too many request',
  },

//  otherPosts: {
//    windowMs: 60 * 60 * 1000, // 1 hour window
//    max: 1200000000000000 , // 1 post every 3 sec average, max.
//   },
};
